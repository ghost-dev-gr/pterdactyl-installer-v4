...
# Usage: ./install.sh <FQDN> <SSL true|false> <email> <username> <firstname> <lastname> <password> <wings true|false>
...
panel_install(){
    ...
    # Fix for utf8mb4 collation issue
    ...
    # Install PHP 8.3 (can be changed if panel requires different)
